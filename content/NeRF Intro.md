...
![image-20250112135007277](https://kennels.oss-cn-beijing.aliyuncs.com/img_for_typora/image-20250112135007277.png)
...
![image-20250112141327514](https://kennels.oss-cn-beijing.aliyuncs.com/img_for_typora/image-20250112141327514.png)

先把世界坐标encode成60维向量作为网络的输入

![image-20250112145922224](https://kennels.oss-cn-beijing.aliyuncs.com/img_for_typora/image-20250112145922224.png)

NeRF用公式算出。Mip-NeRF远处概率分布得到的颜色决定近处颜色。

![image-20250112150117199](https://kennels.oss-cn-beijing.aliyuncs.com/img_for_typora/image-20250112150117199.png)

这里没看懂，先不管了。大概意思是把一个低维的信息拆解成 多种信息/事件的概率分布，方便神经网络学习规律。

然后对每个采样点使用 MLP 输出体积密度/不透明度 $\sigma$ 和颜色 $c(r, g, b)$。

![image-20250112145746938](https://kennels.oss-cn-beijing.aliyuncs.com/img_for_typora/image-20250112145746938.png)
...
![image-20250112144422373](https://kennels.oss-cn-beijing.aliyuncs.com/img_for_typora/image-20250112144422373.png)
